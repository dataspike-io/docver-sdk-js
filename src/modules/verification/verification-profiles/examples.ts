import { SearchProfileRequest } from './models/search-profile-request.ts';
import { VerificationBiometricTypeEnum, VerificationDocumentTypeEnum } from '../../../enums/index.js';
import { BaseProfileModel, CreateVerificationLinkRequest } from './models/index.js';
...
const createProfileTest = {
  ...
  'settings': {
    ...
    'poi_allowed_documents': [
      VerificationDocumentTypeEnum.PASSPORT, VerificationDocumentTypeEnum.VISA,
    ] as VerificationDocumentTypeEnum[],
    'face_comparison_required': true,
    'face_comparison_allowed_documents': [
      VerificationBiometricTypeEnum.SELFIE,
    ] as VerificationBiometricTypeEnum[],
    'poa_required': true,
